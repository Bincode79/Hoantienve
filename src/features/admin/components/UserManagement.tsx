    ...
    <div className="w-full bg-white rounded-md overflow-hidden shadow-md border border-[#06427D]">
      <div className="bg-[#06427D] py-2.5 px-4 flex items-center justify-between border-b border-[#0A73D1]">
        <div className="flex items-center gap-2">
          ...
          <h3 className="text-white font-bold text-[16px] uppercase font-sans tracking-wide">Danh sách người dùng</h3>
        </div>
        <button 
        ...
        <div className="flex flex-col md:flex-row justify-between items-center gap-3 bg-gray-50 p-2.5 border border-gray-200 rounded mb-3">
          ...
          <div className="flex items-center gap-2">
            <select
              ...
              className="px-2.5 py-1.5 text-[12px] font-bold border border-gray-300 rounded bg-white outline-none focus:border-blue-500 cursor-pointer"
            >
          ...
          <table className="w-full text-left text-[13px] text-gray-700 min-w-[700px]">
            ...
            <tbody className="divide-y divide-gray-200">
              {isLoading ? (
                ...
                <tr>
                  <td colSpan={5} className="px-3 py-6 text-center text-red-500 font-bold italic border-t border-gray-200 bg-red-50">
